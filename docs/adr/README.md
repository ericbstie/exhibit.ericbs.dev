...
| [0002](0002-per-app-runtime-composition.md) | Per-app runtime composition — one `exhibit-app@` template in a persistent netns. **Amended per #18, #28.** | [#11](https://github.com/ericbstie/exhibit.ericbs.dev/issues/11) |
